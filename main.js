...
if (!window.update) {
	function update() {
		...
		afkData.pointGain = afkData.points.div(25).add(1).root(3).mul(afkData.power.add(1).pow(2)).mul(new Decimal("e5e4").pow(afkData.greyStars.div(2).pow(1.25)));
		afkData.pointMulti = afkData.points.add(1).log(50).add(1).pow(2.5).mul(new Decimal(2).pow(afkData.infinities.add(afkData.power.add(1).log(5)).div(10).root(1.25)).mul(new Decimal(2).pow(afkData.ranks.root(1.1))).mul(new Decimal("e2.5e3").pow(afkData.stars.pow(1.5))).mul(new Decimal("e1e4").pow(afkData.blueStars.pow(1.5))));
		...
		if (Decimal.gte(afkData.points,new Decimal(Number.MAX_VALUE).mul(new Decimal(2).pow(afkData.infinities.root(2)))) && Decimal.gte(afkData.infinities,25)) {
			...
			afkData.infinityMulti = afkData.infinities.log(25).pow(5).root(afkData.infinities.add(1).log(1e6).add(1)).mul(new Decimal(4).pow(afkData.stars.root(1.5)))
