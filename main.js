...
if (!window.update) {
	function update() {
		...
		afkData.pointMulti = afkData.points.add(1).log(50).add(1).pow(2.5).mul(new Decimal(2).pow(afkData.infinities.add(afkData.power.add(1).log(5)).div(10).root(1.25)).mul(new Decimal(2).pow(afkData.ranks.root(1.1))).mul(new Decimal("e250").pow(afkData.stars.pow(1.5))).mul(new Decimal("e1e3").pow(afkData.blueStars.pow(1.5))));
		...
		if (Decimal.gte(afkData.points,new Decimal(Number.MAX_VALUE).mul(new Decimal(2).pow(afkData.infinities.root(2)))) && Decimal.gte(afkData.infinities,25)) {
			...
			afkData.infinityMulti = afkData.infinities.log(25).pow(5).root(afkData.infinities.add(1).log(1e6).add(1)).mul(new Decimal(1.1).pow(afkData.stars.root(1.5)))
